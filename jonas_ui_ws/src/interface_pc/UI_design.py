...
def setupUi(self):
    ...
    self.face1_button.clicked.connect(lambda: self.set_face(0))
    ...
    self.face2_button.clicked.connect(lambda: self.set_face(1))
    ...
    self.face3_button.clicked.connect(lambda: self.set_face(2))
    ...
    self.face4_button.clicked.connect(lambda: self.set_face(3))
    ...
    self.face5_button.clicked.connect(lambda: self.set_face(4))
